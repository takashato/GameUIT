...
void PlayerElectricShock::Enter(Player& player, EPlayerState fromState, Data&& data)
{
...
Data PlayerElectricShock::Exit(Player& player, EPlayerState toState)
{
	return std::move(data);
}

void PlayerElectricShock::Update(Player& player, float deltaTime)
{
...
void PlayerElectricShock::HandleKeyboard(Player& player, Keyboard* keyboard)
{
}

void PlayerElectricShock::OnKeyDown(Player& player, BYTE code)
{
}

void PlayerElectricShock::OnKeyUp(Player& player, BYTE code)
{
}

void PlayerElectricShock::OnCollision(Player& player, std::vector<CollisionEvent*>& cEvent)
{
